...
export const Route = createFileRoute("/add-vehicle")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Add a vehicle to the VCH fleet with registration lookup auto-fill." },
      { property: "og:title", content: "Add Vehicle — Virtual Car Hire" },
      { property: "og:description", content: "Add a vehicle to the VCH fleet with registration lookup auto-fill." },
