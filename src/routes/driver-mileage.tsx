...
export const Route = createFileRoute("/driver-mileage")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track driver mileage allowances, excess miles and monthly charges." },
      { property: "og:title", content: "Driver Mileage — Virtual Car Hire" },
      { property: "og:description", content: "Track driver mileage allowances, excess miles and monthly charges." },
