...
export const Route = createFileRoute("/accident-cases")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-triaged accident reports with severity, vehicle and driver details." },
      { property: "og:title", content: "Accident Cases — Virtual Car Hire" },
      { property: "og:description", content: "AI-triaged accident reports with severity, vehicle and driver details." },
